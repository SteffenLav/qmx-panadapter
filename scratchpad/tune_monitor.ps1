# Non-interactive serial capture for long Tune monitoring. Writes to a fixed file.
$portName = "COM3"
$logFile  = "C:\dev\qmx-panadapter\scratchpad\tune_monitor.log"

"=== Tune monitor capture started $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss') on $portName @921600 ===" |
