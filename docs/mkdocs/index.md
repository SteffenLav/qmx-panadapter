...
**v1.3.5 — a complete, self-contained FT8/FT4 station with no PC in the loop.**
...
**Want the whole guide at once?** Download the [User Guide PDF](QMX-Panadapter-UserGuide-v1.3.5.pdf) — a printable 40-page reference.
