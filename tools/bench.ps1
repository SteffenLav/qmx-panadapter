...
function Assert-BoardMatches {
    # ⛔ THE GUARD THAT WAS MISSING. `idf.py -B build_ws flash` with no
    # -D SDKCONFIG= builds the ROOT sdkconfig - on the port tree that is the
    # TAB5 config - and flashes it happily. This board has already been
